            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    <FormField
                        ...
                        name="rank"
                        render={({ field }) => (
                            <FormItem className="flex flex-col gap-2 md:flex-row md:justify-between md:items-center">
                                <div className="flex flex-row gap-2 md:gap-5 items-center md:items-start">
                                    <div className="flex items-center justify-center text-base text-white bg-blue-900 rounded-full size-6 min-w-6">1</div>
                                    <FormLabel className="text-sm md:text-base">Update your <span className="font-bold">Rank</span></FormLabel>
                                </div>
                                <div>
                                    <FormControl>
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-col gap-2 md:flex-row md:justify-between md:items-center">
                                 <div className="flex flex-row gap-5 items-start">
                                    ...
                                    <FormLabel className="text-sm md:text-base">Update your <span className="font-bold">Percentile</span></FormLabel>
                                </div>
                                <div>
                                <FormControl>
                                    <Input type="number" {...field} onChange={field.onChange} />
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-col gap-2 md:flex-row md:justify-between md:items-center">
                                <div className="flex flex-row gap-5 items-start">
                                    ...
                                    <FormLabel className="text-sm md:text-base">Update your <span className="font-bold">Current Score (out of 15)</span></FormLabel>
                                </div> 
                                <div>
                                <FormControl>
